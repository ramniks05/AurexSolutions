...
const blocks = [
  ...
  },
  {
    id: 'values',
    title: 'Our Values',
    text: 'Quality in materials and craftsmanship, integrity in every interaction, and Aurex Solutions\' commitment to understanding and meeting clients\' needs.',
  },
]
  ...
  return (
    <section id="mission-vision" className="mission-vision section section-alt">
      <h2 className={`section-title mission-vision-title ${inView ? 'reveal' : ''}`} ref={ref}>
        Aurex Solutions – Mission, Vision & Values
      </h2>
