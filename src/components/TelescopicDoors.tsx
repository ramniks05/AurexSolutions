...
const products = [
  ...
  },
  {
    ...
    extra: 'Anodised aluminium-framed telescopic doors with soft-close sliding system along with designs created using Georgian bars and various glass patterns.',
  },
  {
    ...
    frame: ['Champagne', 'Black', 'Bronze', 'Grey', 'Brush Gold'],
    extra: 'Anodised Aluminium full-frame telescopic sliding system with concealed mechanism',
  },
]
