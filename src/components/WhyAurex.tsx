...
const values = [
  {
    title: 'Quality',
    text: 'Aurex Solutions delivers premium materials and craftsmanship in every project.',
    icon: (
  ...
  {
    title: 'Expertise',
    text: 'Aurex Solutions brings years of experience in delivering solutions that exceed expectations.',
    icon: (
      <svg className="why-aurex-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
  ...
  {
    title: 'Reliability',
    text: 'Aurex Solutions ensures consistent delivery and clear communication from start to finish.',
    icon: (
      <svg className="why-aurex-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
