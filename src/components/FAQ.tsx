...
const items = [
  ...
  },
  {
    ...
    a: 'Reach out via the contact option above. Aurex Solutions will arrange a consultation to understand your needs and outline the next steps.',
  },
  {
    q: 'Do you work across different industries?',
    a: 'Yes. Aurex Solutions serves residential, commercial, hospitality, and other sectors with the same commitment to quality and reliability.',
  },
]
